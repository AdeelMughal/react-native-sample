...
const moderateRatio = (size, factor = 0.5) =>
...
export default {
  ...
  moderateBaseMargin: moderateRatio(16),
  doubleModerateBaseMargin: moderateRatio(32),
  ...
  carouselItem: moderateRatio(200),
  baseMarginTop: moderateRatio(16),
};
